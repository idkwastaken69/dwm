...
static const char col_gray4[]       = "#ffc2c7";
static const char col_pink1[]       = "#fa848e";
static const char col_pink2[]       = "#ffb4b9";
static const char col_pink3[]       = "#ffdcdf";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_pink3, col_black, col_gray2 },
	[SchemeSel]  = { col_pink2, col_black,  col_pink1  },
};
